package
{
   ...
   import net.bigpoint.deprecated.gui.view.components.infoWindows.CinemaInfoContent;
   
   [ExcludeClass]
   public class _net_bigpoint_deprecated_gui_view_components_infoWindows_CinemaInfoContentWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_deprecated_gui_view_components_infoWindows_CinemaInfoContentWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         CinemaInfoContent.watcherSetupUtil = new _net_bigpoint_deprecated_gui_view_components_infoWindows_CinemaInfoContentWatcherSetupUtil();
      }
