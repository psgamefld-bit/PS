package
{
   ...
   import net.bigpoint.deprecated.gui.view.components.infoWindows.LevelUpInfoContent;
   
   [ExcludeClass]
   public class _net_bigpoint_deprecated_gui_view_components_infoWindows_LevelUpInfoContentWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_deprecated_gui_view_components_infoWindows_LevelUpInfoContentWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         LevelUpInfoContent.watcherSetupUtil = new _net_bigpoint_deprecated_gui_view_components_infoWindows_LevelUpInfoContentWatcherSetupUtil();
      }
