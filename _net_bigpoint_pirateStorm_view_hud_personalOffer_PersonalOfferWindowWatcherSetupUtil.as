package
{
   ...
   import net.bigpoint.pirateStorm.view.hud.personalOffer.PersonalOfferWindow;
   
   [ExcludeClass]
   public class _net_bigpoint_pirateStorm_view_hud_personalOffer_PersonalOfferWindowWatcherSetupUtil implements IWatcherSetupUtil2
   {
      
      public function _net_bigpoint_pirateStorm_view_hud_personalOffer_PersonalOfferWindowWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         PersonalOfferWindow.watcherSetupUtil = new _net_bigpoint_pirateStorm_view_hud_personalOffer_PersonalOfferWindowWatcherSetupUtil();
      }
